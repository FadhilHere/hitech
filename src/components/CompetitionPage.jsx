...
import uiuxIcon from "/mascot4.png";
import visdatIcon from "/maskot6.png";
import bplanIcon from "/maskot3.png";
          ...
          {competitionList.map((item, index) => (
            ...
            >
              ...
              <button
                ...
                className="mt-6 px-6 py-2 bg-yellow-300 text-[#1F4180] font-semibold rounded-lg hover:bg-yellow-400 transition duration-300"
              >
                Go to {item.title}
              </button>
            </div>
